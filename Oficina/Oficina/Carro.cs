    ...
    public class Carro
    {
        ...
        public Pneu PneuTrazeiroDireito
        {
            ...
            set { 
                ...
                pneuTrazeiroDireito = value;
                    ...
                    Console.WriteLine("Desligar o Carro ai ");
            }
        }
        ...
        public void Acelerar(int _impulso)
        {
            ...
            if (Ligado = true) 
            {
                ...
                if (PneuDianteiroDireito.Estourado  || PneuDianteiroEsquerdo.Estourado || PneuTrazeiroDireito.Estourado || pneuTrazeiroEsquerdo.Furado)
                {
                    Frear(VelocidadeAtual);
                }
            }
